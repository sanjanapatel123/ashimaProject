...
//     localStorage.setItem("user", JSON.stringify(credentials[role]));
...
//             className="border-2 p-2 rounded-full border-black bg-teal-700 text-white hover:bg-teal-600 transition duration-300"
//           >
//             Admin Login
//           </button>
//           <button
//             onClick={() => handleLogin("student")}
//             className="border-2 p-2 rounded-full border-black bg-black text-white hover:bg-gray-700 transition duration-300"
//           >
//             Student Login
//           </button>
//           <button
//             onClick={() => handleLogin("instructor")}
//             className="border-2 p-2 rounded-full border-black bg-red-700 text-white hover:bg-red-600 transition duration-300"
//           >
//             Instructor Login
//           </button>
//         </div>

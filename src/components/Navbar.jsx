...
//   return (
//     <nav className="text-black min-h-[70px] fixed lg:rounded-lg w-full top-0 z-50 bg-white shadow-md lg:w-[calc(100%-4rem)] ml-1">
//       {" "}
...
//   return (
//     <nav className="text-black min-h-[70px] fixed top-0 z-50 w-full bg-white shadow-md lg:rounded-lg lg:w-[calc(100%-4rem)] ml-1">
//       <div className="FF mx-auto flex justify-between items-center py-3 px-4 md:px-6">
...
//           {/* Desktop Menu */}
//           <ul className="hidden md:flex justify-center space-x-10 ml-10 xl:ml-40 items-center font-Roboto Condensed mt-2">
//             <Link to="/AllCourses" className="no-underline">
//               <li className="cursor-pointer font-[500] text-[18px] text-[#1e1e1e] hover:text-[#00E0C6] transition">
//                 Courses
//               </li>
...
//         >
//           <ul className="space-y-4 font-Roboto Condensed text-[#1e1e1e] text-[18px] font-[500]">
//             <Link to="/AllCourses" className="no-underline">
//               <li className="cursor-pointer">Courses</li>
//             </Link>
//             <li className="cursor-pointer">Business</li>
//             <li className="cursor-pointer">Digital Products</li>
//             <li className="cursor-pointer">Newsletter</li>
//           </ul>
//           <div className="mt-6 space-y-3">
//             <button className="w-full px-4 py-2 text-white rounded-lg bg-[#1e1e1e]">
//               Instructor
//             </button>
//             <Link to="/login">
//               <button className="w-full px-4 py-2 text-white rounded-lg bg-[#047670]">
//                 Login
//               </button>
//             </Link>
//           </div>

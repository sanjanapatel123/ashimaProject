...
export default function Navbar() {
  ...
  return (
    <nav className=" text-white bg-transparent p-6 sm:p-2 md:p-2 fixed w-full top-0 z-50">
      <div className="container mx-auto flex justify-between items-center">
        <h1 className="text-2xl font-bold">AiSkills</h1>

        {/* Desktop Menu */}
        <ul className="hidden md:flex space-x-6">
          <li className="flex items-center px-4 py-2 border border-white rounded-lg font-semibold cursor-pointer">
        ...
        <div className="flex items-center md:hidden">
          ...
          <button className="flex items-center px-4 py-2 border border-white rounded-lg  font-semibold text-lg mr-4">
            Courses
      ...
      {isOpen && (
        ...
        >
          <ul className="space-y-4 text-white">
            ...
            <li className="hover:text-gray-950 cursor-pointe">
              Newsletter
            </li>
          </ul>

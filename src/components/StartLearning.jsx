      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 mt-12">
          ...
          <div className="bg-gray-900 rounded-lg p-6 sm:p-8 text-center w-full max-w-md">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-5 mt-6 sm:mt-8 text-white">
              {/* App Store Section */}
              <div className="flex items-center">
                <button className="flex items-center">
                  <i className="fa-brands fa-app-store text-xl sm:text-2xl mr-2"></i>
                  <span>App Store</span>
                </button>
              </div>
              ...
              <div className="flex items-center">
                <button className="flex items-center">
                  <i className="fa-brands fa-google text-xl sm:text-2xl mr-2"></i>
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-8 items-center">
            ...
            <button className="flex items-center justify-center">
              <svg
                ...
                viewBox="0 0 512 512"
                className="h-12 w-12 sm:h-16 sm:w-16 text-green-900"
              >

...
//     <>
//       {/* Top Header */}
//       <div className="h-[80px] mx-auto px-4 flex items-center justify-between shadow-sm bg-white">
//         {/* Left: Logo */}
...
//           <div className="flex items-center border border-[#1E1E1ECC] rounded-full px-4 py-2 w-[350px]">
//             <svg
...
//           <Link to="/business">
//             <span className="font-roboto block font-medium text-[18px]  text-[#000000]">
//               Business
//             </span>
//           </Link>
//           <Link to="/digital">
//             <span className="font-roboto block font-medium text-[16px] text-[#000000]">
//               Digital Product
//             </span>
//           </Link>
//           <Link to="/newsletter">
//             <span className="font-roboto block font-medium text-[18px]  text-[#000000] cursor-pointer ">
//               Newsletter
//             </span>
//           </Link>
...
const Header = () => {
  ...
  return (
    <>
      {/* Top Header */}
      <div className="h-[80px] mx-auto px-4 flex items-center justify-between shadow-sm bg-[#ffffff] fixed top-0 left-0 right-0 z-50">
        {/* Left: Logo */}
        <div className="font-[Impact] font-normal text-[50px] leading-[55px] tracking-[0.005em] text-[#000000] whitespace-nowrap">
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-[#ffffff] rounded-b-md shadow-md max-w-[1364px] mx-auto p-4 transition-all duration-300 ease-in-out">
          <Link to="/business">
            <span className="font-roboto block font-medium text-[18px] text-[#000000]">
              Business
            </span>
      ...
      {isMobileMenuOpen && (
        <div className="fixed bottom-0 left-0 right-0 bg-white shadow-md p-4 flex justify-center gap-4 z-50">
          <Link
            to="/login"
            className="text-[#047670] font-medium px-4 py-2 block border rounded-lg border-[#047670] bg-[#ffffff]"
          >
            Login
          </Link>
          <Link

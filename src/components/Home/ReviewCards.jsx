...
//       {/* Testimonials Grid */}
//       <div className="flex flex-wrap justify-center gap-6 font-Roboto Condensed">
...
<div className="flex flex-wrap justify-center gap-6 font-Roboto Condensed mt-5">
  {testimonials.map((testimonial, index) => (
    <div
      key={index}
      className="relative bg-[#0F7768] text-white w-full sm:w-[48%] lg:w-[31.5%] min-h-[350px] p-6 rounded-xl shadow-lg text-left transition-all duration-300 hover:scale-105"
    >
      {/* ✅ LinkedIn Icon */}

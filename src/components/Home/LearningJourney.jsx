...
//       <div className="max-w-[1366px] mx-auto flex flex-col md:flex-row justify-between items-center  md:text-left">
...
//         {/* Right Side - Text & Button */}
//         <div className="w-full md:w-1/2 flex flex-col items-start text-left ml-16">
